...
/client/proc/respawn_character()
	...
	if(!new_character.mind.assigned_role)
		new_character.mind.assigned_role = "Stowaway"//If they somehow got a null assigned role.
...
/client/proc/cmd_admin_create_centcom_decree()
	set category = "Special Verbs"
...
/client/proc/smite(mob/living/carbon/human/target as mob)
	...
	switch(punishment)
		...
		if(ADMIN_PUNISHMENT_ONE)
			...
			C.verbs -= list(/mob/living/carbon/human/verb/suicide)
		...
		if(ADMIN_PUNISHMENT_FRAGGOT)
			...
			for(var/client/C in (GLOB.clients - target.client))
				...
				to_chat(C, "<span class='warning'><span class='big bold'>[emoji_parse(":killher:")][target.real_name] IS A NIGGER FRAGGOT! KILL HER! KILL HER![emoji_parse(":killher:")]</span>")
		//
