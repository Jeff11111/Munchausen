...
/obj/item/reagent_containers/syringe/afterattack(atom/target, mob/user, proximity)
	...
	switch(mode)
		...
		if(SYRINGE_INJECT)
			...
			to_chat(user, "<span class='[user.a_intent == INTENT_HARM ? "danger" : "notice"]'>You [user.a_intent == INTENT_HARM ? "stab-" : ""]inject [user.a_intent == INTENT_HARM ? reagents.total_volume : amount_per_transfer_from_this] units of the solution. The syringe now contains [reagents.total_volume] units.</span>")
...
/obj/item/reagent_containers/syringe/antitox
...
/obj/item/reagent_containers/syringe/lethal/execution
	list_reagents = list(/datum/reagent/toxin/amatoxin = 15, /datum/reagent/toxin/formaldehyde = 15, /datum/reagent/toxin/cyanide = 10, /datum/reagent/toxin/acid/fluacid = 10)
