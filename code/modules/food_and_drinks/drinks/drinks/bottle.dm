...
/obj/item/reagent_containers/food/drinks/bottle/attack(mob/living/target, mob/living/user)
	...
	if(target != user)
		target.visible_message("<span class='danger'><b>[user]</b> has hit <b>[target]</b>[head_attack_message] with a bottle of [src.name]!</span>", \
				"<span class='userdanger'><b>[user]</b> has hit <b>[target]</b>[head_attack_message] with a bottle of [src.name]!</span>")
	else
		user.visible_message("<span class='danger'><b>[target]</b> hits [target.p_them()]self with a bottle of [src.name][head_attack_message]!</span>", \
				"<span class='userdanger'><b>[target]</b> hits [target.p_them()]self with a bottle of [src.name][head_attack_message]!</span>")
