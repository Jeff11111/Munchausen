...
/obj/effect/mob_spawn/human/lavaland_syndicate/comms
	...
	important_info = "Do not attack the station unprovoked. Contact your superiors before you even THINK of making a move on the station that would be aggressive!"
