...
/mob/living/simple_animal/bot/cleanbot
	...
	var/static/list/officers = list("Captain", "Head of Personnel", "Chief Enforcer")
	var/static/list/command = list("Captain" = "Cpt.","Head of Personnel" = "Lt.")
	var/static/list/security = list("Chief Enforcer" = "Maj.", "Warden" = "Sgt.", "Detective" =  "Det.", "Security Officer" = "Officer")
	var/static/list/engineering = list("Senior Engineer" = "Senior Engineer", "Station Engineer" = "Engineer", "Atmospherics Technician" = "Technician")
