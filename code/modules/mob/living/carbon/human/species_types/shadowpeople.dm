...
/datum/species/shadow
	...
	species_traits = list(NOBLOOD,NOEYES,CAN_SCAR,HAS_FLESH,HAS_BONE)
	...
	languagewhitelist = list("Shadowtongue")
...
/datum/species/shadow/nightmare
	...
	species_traits = list(NOBLOOD,NO_UNDERWEAR,NO_DNA_COPY,NOTRANSSTING,NOEYES,NOGENITALS,NOAROUSAL,CAN_SCAR,HAS_FLESH,HAS_BONE)
