...
/mob/camera/blob/proc/create_shield(turf/T)
	...
	if(S)
		...
		createSpecial(10, /obj/structure/blob/shield, 0, 0, T)

/mob/camera/blob/verb/create_resource()
	set category = "Blob"
	set name = "Create Resource Blob (25)"
	set desc = "Create a resource tower which will generate resources for you."
	createSpecial(25, /obj/structure/blob/resource, 4, 1)

/mob/camera/blob/verb/create_node()
	set category = "Blob"
	set name = "Create Node Blob (40)"
	set desc = "Create a node, which will power nearby factory and resource blobs."
	createSpecial(40, /obj/structure/blob/node, 5, 0)

/mob/camera/blob/verb/create_factory()
	set category = "Blob"
	set name = "Create Factory Blob (50)"
	set desc = "Create a spore tower that will spawn spores to harass your enemies."
	createSpecial(50, /obj/structure/blob/factory, 5, 1)

/mob/camera/blob/verb/create_blobbernaut()
	set category = "Blob"
	set name = "Create Blobbernaut (40)"
	set desc = "Create a powerful player-controlled blobbernaut you can communicate and coordinate with to fend off attackers."
	var/turf/T = get_turf(src)
