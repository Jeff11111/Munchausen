...
/datum/supply_pack/engineering/engihardsuit
	...
	desc = "Poly 'Who stole all the hardsuits?!' Well now you can get more hardsuits if needed! NOTE: THERE IS ONLY ONE HARDSUIT IN THIS CRATE, as well as one air tank and mask!"
	cost = 2250
...
/datum/supply_pack/engineering/atmoshardsuit
	...
	desc = "Too many techs and not enough hardsuits? Time to buy some more! Comes with gas mask and air tank. Requires CE access to open."
	cost = 5000
...
/datum/supply_pack/engineering/radvoidsuit
	...
	desc = "The Singulo is loose? Do you need to do a few changes to its containment and don't want to spend the rest of the shift under the shower? Get this Radiation Hardsuit! It protects from radiations and space only."
	cost = 3500
	access = ACCESS_ENGINE
	contains = list(/obj/item/tank/internals/air,
					/obj/item/clothing/mask/gas,
...
/datum/supply_pack/engineering/industrialrcd
	name = "Industrial RCD"
	desc = "An industrial RCD in case the station has gone through more then one meteor storm and the CE needs to bring out somthing a bit more reliable. Does not contain spare ammo for the industrial RCD or any other RCD models."
	cost = 4500
	access = ACCESS_CE
...
/datum/supply_pack/engineering/power
	...
	desc = "Looking for overwhelming power? Look no further. Contains three high-voltage power cells."
	cost = 1000
...
/datum/supply_pack/engineering/dna_vault
	...
	desc = "Secure the longevity of the current state of civilization within this massive library of scientific knowledge, capable of granting superhuman powers and abilities. Highly advanced research is required for proper construction. Also contains five DNA probes."
	cost = 12000
	special = TRUE
	contains = list(
