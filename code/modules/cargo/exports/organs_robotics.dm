...
/datum/export/organs/cybernetic
	...
	export_types = list(/obj/item/organ/liver/cybernetic, /obj/item/organ/lungs/cybernetic, /obj/item/bodypart/right_eye/robot, /obj/item/bodypart/left_eye/robot, /obj/item/organ/heart/cybernetic)
