...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		if("grey") //God help you
			jobs_to_revolt = list("Stowaway")
			nation_name = pick("Assa", "Mainte", "Tunnel", "Gris", "Grey", "Liath", "Grigio", "Ass", "Assi")
		if("white")
			jobs_to_revolt = list("Chief Medical Officer", "Medical Doctor", "Chemist", "Geneticist", "Paramedic", "Virologist", "Psychologist")
		...
		if("brown")
			jobs_to_revolt = list("Logistics Officer", "Cargo Technician", "Shaft Miner")
		...
		if("whatevercolorrepresentstheservicepeople") //the few, the proud, the technically aligned
			jobs_to_revolt = list("Bartender", "Cook", "Botanist", "Jester", "Mime", "Janitor", "Chaplain")
