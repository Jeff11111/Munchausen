...
/datum/uplink_item/role_restricted/goldenbox
	...
	restricted_roles = list("Stowaway", "Curator") //Curator due to this being made of gold - It fits the theme
...
/datum/uplink_item/role_restricted/emitter_cannon
	...
	restricted_roles = list("Senior Engineer", "Station Engineer", "Atmospheric Technician")
