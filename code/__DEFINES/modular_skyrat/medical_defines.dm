...
#define AMPUTATE_BODYPARTS list(BODY_ZONE_PRECISE_NECK, BODY_ZONE_R_ARM, \
					BODY_ZONE_L_ARM, BODY_ZONE_PRECISE_GROIN, \
					BODY_ZONE_R_LEG, BODY_ZONE_L_LEG, \
					BODY_ZONE_PRECISE_R_HAND, BODY_ZONE_PRECISE_L_HAND, \
					BODY_ZONE_PRECISE_R_FOOT, BODY_ZONE_PRECISE_L_FOOT)
#define LIMB_AND_HEAD_BODYPARTS list(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_NECK, \
...
#define SSPARTS	list(/obj/item/bodypart/head, /obj/item/bodypart/neck, \
