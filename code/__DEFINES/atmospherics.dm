...
#define BODYTEMP_HEAT_DAMAGE_LIMIT			(BODYTEMP_NORMAL + 20) // The limit the human body can take before it starts taking damage from heat.
...
#define MAX_HIGH_PRESSURE_DAMAGE			16
...
#define LAVALAND_DEFAULT_ATMOS "o2=8;n2=96;TEMP=305"

//SNOSTATION
#define ICEMOON_DEFAULT_ATMOS "o2=20;n2=84;TEMP=180"
