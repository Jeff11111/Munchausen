...
#define HUMAN_CRIT_MAX_OXYLOSS (SSmobs.wait/2 SECONDS)
...
#define NUTRITION_LEVEL_CRITICAL 50
...
//Shit levels
#define DEFECATION_LEVEL_SHITPANTS 600
#define DEFECATION_LEVEL_FULL 500
#define DEFECATION_LEVEL_POOPENFARDEN 400
#define DEFECATION_LEVEL_VERY_POOPY 300
#define DEFECATION_LEVEL_POOPY 200
#define DEFECATION_LEVEL_NONE 0

#define DEFECATION_LEVEL_START_MIN 0
#define DEFECATION_LEVEL_START_MAX 200

//Piss levels
#define URINATION_LEVEL_PISSPANTS 600
...
#define	HUNGER_FACTOR		0.125	//factor at which mob nutrition decreases
