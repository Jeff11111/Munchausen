...
#define GOON_GENERAL_AMBIENT_OCCLUSION list("type" = "drop_shadow", "x" = 2, "y"= -2, "size" = 4, "offset"= 1, "color"=rgb(4, 8, 16, 150))
#define BURGER_WALL_AMBIENT_OCCLUSION1 list("type" = "drop_shadow", "x"= 1, "y"= 1, "size"=4, "offset"= 0, "color" = rgb(20, 20, 20, 150))
#define BURGER_WALL_AMBIENT_OCCLUSION2 list("type" = "drop_shadow", "x"= -1, "y"= -1, "size"=4, "offset"= 0, "color" = rgb(20, 20, 20, 150))
