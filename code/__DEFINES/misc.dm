...
#define BURGER_WALL_AMBIENT_OCCLUSION1 list("type"="drop_shadow", "x"=0, "y"= -2, "size"=2, "offset"=0, "color"=rgb(0,0,0))
#define BURGER_WALL_AMBIENT_OCCLUSION2 list("type"="drop_shadow", "x"=0, "y"= 2, "size"=2, "offset"=0, "color"=rgb(0,0,0))
