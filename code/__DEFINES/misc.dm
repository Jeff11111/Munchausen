...
#define BURGER_WALL_AMBIENT_OCCLUSION1 list("type" = "drop_shadow", "x"= 2, "y"= 2, "size"= 4, "offset"= 0, "color" = rgb(20, 20, 20, 100))
#define BURGER_WALL_AMBIENT_OCCLUSION2 list("type" = "drop_shadow", "x"= -2, "y"= -2, "size"= 4, "offset"= 0, "color" = rgb(20, 20, 20, 100))
