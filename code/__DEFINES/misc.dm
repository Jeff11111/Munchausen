...
#define BURGER_WALL_AMBIENT_OCCLUSION1 list("type" = "drop_shadow", "x"= 1, "y"= 1, "size"=1, "offset"= 0, "color" = rgb(55, 55, 75, 120))
#define BURGER_WALL_AMBIENT_OCCLUSION2 list("type" = "drop_shadow", "x"= -1, "y"= -1, "size"=1, "offset"= 0, "color" = rgb(25, 25, 30, 150))
