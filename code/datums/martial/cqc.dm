...
/datum/martial_art/cqc/proc/Pressure(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.apply_damage(damage, STAMINA, wound_bonus = CANT_WOUND)
	playsound(get_turf(A), 'sound/weapons/cqchit1.ogg', 50, 1, -1)
	return TRUE
...
/datum/martial_art/cqc/proc/Consecutive(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat)
		...
		if(I && D.temporarilyRemoveItemFromInventory(I))
			A.put_in_hands(I)
		D.apply_damage(damage + 45, STAMINA, wound_bonus = CANT_WOUND)
...
/datum/martial_art/cqc/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!CHECK_MOBILITY(A, MOBILITY_STAND) && !D.stat && CHECK_MOBILITY(D, MOBILITY_STAND))
		...
		D.apply_damage(bonus_damage, BRUTE, wound_bonus = CANT_WOUND)
...
/datum/martial_art/cqc/disarm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(CHECK_MOBILITY(D, MOBILITY_MOVE) || !restraining)
		...
		if(damage >= stunthreshold)	
			...
			D.Jitter(2)
			D.Dizzy(damage)
			D.apply_damage(damage*2 + 20, STAMINA, wound_bonus = CANT_WOUND)
			...
			D.apply_damage(damage + 15, STAMINA, wound_bonus = CANT_WOUND)
			D.apply_damage(damage*0.5, BRUTE)
