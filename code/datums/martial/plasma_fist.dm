...
/datum/martial_art/plasma_fist/proc/Throwback(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message("<span class='danger'><b>[A]</b> has hit <b>[D]</b> with Plasma Punch!</span>", \
								"<span class='userdanger'><b>[A]</b> has hit <b>[D]</b> with Plasma Punch!</span>")
...
/datum/martial_art/plasma_fist/proc/Plasma(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message("<span class='danger'><b>[A] has hit [D] with THE PLASMA FIST TECHNIQUE!</span>", \
								"<span class='userdanger'><b>[A]</b> has hit <b>[D]</b> with THE PLASMA FIST TECHNIQUE!</span>")
	D.gib()
