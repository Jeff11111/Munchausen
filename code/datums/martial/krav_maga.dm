...
/datum/martial_art/krav_maga/proc/leg_sweep(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.apply_damage(damage, STAMINA, affecting, armor_block, wound_bonus = CANT_WOUND)
...
/datum/martial_art/krav_maga/proc/neck_chop(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	playsound(get_turf(A), 'sound/effects/hit_punch.ogg', 50, 1, -1)
	D.apply_damage(damage, BRUTE, wound_bonus = CANT_WOUND)
	if(D.silent <= 10)
...
/datum/martial_art/krav_maga/disarm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(CHECK_MOBILITY(D, MOBILITY_STAND))
		...
		D.apply_damage(damage*2 + 15, STAMINA, affecting, armor_block, wound_bonus = CANT_WOUND)
		...
		A.do_attack_animation(D, ATTACK_EFFECT_KICK)
		playsound(D, 'sound/effects/hit_punch.ogg', 50, TRUE, -1)
		D.apply_damage(damage*2 + 20, STAMINA, affecting, armor_block, wound_bonus = CANT_WOUND)
...
/obj/item/clothing/gloves/krav_maga/sec
	...
	desc = "These gloves look cool but they don't actually do much, despite their name implying otherwise."
...
/obj/item/clothing/gloves/krav_maga/combatglovesplus
	...
	desc = "These tactical gloves are fireproof and shock resistant. That's about it."
	siemens_coefficient = 0
	permeability_coefficient = 0.05
	strip_delay = 80
	cold_protection = HANDS
