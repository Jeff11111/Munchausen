...
/obj/item/bedsheet/hos
	name = "chief enforcer's bedsheet"
	desc = "It is decorated with a shield emblem. While crime doesn't sleep, you do, but you are still THE LAW!"
	icon_state = "sheethos"
	dream_messages = list("authority", "a silvery ID", "handcuffs", "a baton", "a flashbang", "sunglasses", "the chief enforcer")
...
/obj/item/bedsheet/ce
	name = "senior engineer's bedsheet"
