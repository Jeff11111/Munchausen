...
/obj/item/cane
	name = "cane"
	desc = "A cane used by a true gentleman. Or a jester."
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "cane"
	item_state = "stick"
...
/obj/item/slapper/attack(mob/M, mob/living/carbon/human/user)
	...
	if(user.a_intent != INTENT_HARM && ((user.zone_selected == BODY_ZONE_PRECISE_MOUTH) || (user.zone_selected in list(BODY_ZONE_PRECISE_LEFT_EYE, BODY_ZONE_PRECISE_RIGHT_EYE)) || (user.zone_selected == BODY_ZONE_HEAD)))
