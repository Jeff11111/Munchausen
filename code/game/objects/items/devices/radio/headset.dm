...
/obj/item/radio/headset/ComponentInitialize()
	. = ..()
	if (bowman)
		AddComponent(/datum/component/wearertargeting/earprotection, list(SLOT_EARS_LEFT, SLOT_EARS_RIGHT))
...
/obj/item/radio/headset/heads/hos
	name = "\proper the chief enforcer's headset"
	desc = "The headset of the man in charge of keeping order and protecting the station."
	icon_state = "com_headset"
	keyslot = new /obj/item/encryptionkey/heads/hos

/obj/item/radio/headset/heads/hos/alt
	name = "\proper the chief enforcer's bowman headset"
...
/obj/item/radio/headset/headset_clown
	name = "jester's headset"
	desc = "A headset for the jester. Finally, a megaphone you can't take away."
	icon_state = "srv_headset"
	keyslot = new /obj/item/encryptionkey/headset_service
	command = TRUE
