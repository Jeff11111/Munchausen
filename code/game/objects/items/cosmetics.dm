...
/obj/item/razor/attack(mob/M, mob/user)
	if(ishuman(M))
		...
		if((location in list(BODY_ZONE_PRECISE_LEFT_EYE, BODY_ZONE_PRECISE_RIGHT_EYE, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_HEAD)) && !H.get_bodypart_nostump(BODY_ZONE_HEAD))
