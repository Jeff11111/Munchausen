...
/datum/game_mode/clockwork_cult
	...
	enemy_minimum_age = 7
	protected_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Chief Enforcer", "Head of Personnel", "Senior Engineer", "Chief Medical Officer", "Research Director", "Quartermaster") //Silicons can eventually be converted
