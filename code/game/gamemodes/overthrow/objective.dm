...
// based on the role of the head (Captain, HoP/HoS, other heads, lieutenant, enforcers) and whether you converted them, exiled or just killed (applying a modifier of 1.5, 1 and 0.5 respectively)
...
/datum/objective/overthrow/heads/update_explanation_text()
	if(targets.len)
		...
		explanation_text += ". Converting to your team will give you more points, whereas killing will give you the least. Syndicates don't want to stir up too many troubles. Permanent termination/killing of target IS NOT required or wanted."
	else
