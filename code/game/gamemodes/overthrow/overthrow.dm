...
/datum/game_mode/overthrow
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Chief Enforcer", "Captain", "Head of Personnel", "Senior Engineer", "Chief Medical Officer", "Research Director", "Quartermaster")
