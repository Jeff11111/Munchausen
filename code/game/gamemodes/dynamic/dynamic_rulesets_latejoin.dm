...
/datum/dynamic_ruleset/latejoin/provocateur
	...
	enemy_roles = list("AI", "Cyborg", "Security Officer","Detective","Chief Enforcer", "Captain", "Warden")
...
/datum/dynamic_ruleset/latejoin/bloodsucker
	...
	restricted_roles = list("AI", "Cyborg")
	protected_roles = list("Security Officer", "Warden", "Detective", "Brig Physician", "Chief Enforcer", "Captain", "Head of Personnel", "Senior Engineer", "Chief Medical Officer", "Research Director", "Quartermaster")
	required_candidates = 1
	weight = 3
	cost = 10
