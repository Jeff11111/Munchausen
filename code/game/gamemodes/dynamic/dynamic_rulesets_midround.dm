...
/datum/dynamic_ruleset/midround/autotraitor
	...
	protected_roles = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Senior Engineer Engineer", "Senior Engineer Medical Officer", "Research Director", "Quartermaster", "Blueshield") ///Skyrat changes, makes heads of staff no longer traitors
...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Security Officer", "Warden","Detective","Head of Security", "Captain", "Scientist", "Chemist", "Research Director", "Senior Engineer Engineer", "Blueshield") //Skyrat changes adds Blue to list
