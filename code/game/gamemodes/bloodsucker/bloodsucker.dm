...
/datum/game_mode/bloodsucker
	...
	protected_jobs = list("Chaplain", "Enforcer", "Lieutenant", "Detective", "Brig Physician", "Chief Enforcer", "Captain", "Head of Personnel", "Senior Engineer", "Chief Medical Officer", "Research Director", "Logistics Officer")
	required_players = 20
	required_enemies = 2
