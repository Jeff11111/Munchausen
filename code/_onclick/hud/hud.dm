...
/datum/hud
	...
	var/obj/screen/mov_intent/move_intent
...
/datum/hud/New(mob/owner)
	...
	if(!ui_style)
		...
		ui_style = 'modular_skyrat/icons/mob/screen/screen_nigga.dmi'
