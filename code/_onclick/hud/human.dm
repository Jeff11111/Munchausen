...
/datum/hud/human/New(mob/living/carbon/human/owner)
	...
	move_intent = new /obj/screen/mov_intent
	move_intent.icon_state = (mymob.m_intent == MOVE_INTENT_RUN ? "running" : "walking")
	move_intent.screen_loc = ui_movi
	move_intent.hud = src
	static_inventory += move_intent

	sprint = new /obj/screen/sprintbutton
	...
	special_attacks = new /obj/screen/kick_jump_bite
	special_attacks.screen_loc = ui_specialattack
	...
	drop_icon = new /obj/screen/drop()
	drop_icon.icon = ui_style
	drop_icon.screen_loc = ui_drop
	drop_icon.hud = src
	static_inventory += drop_icon
	...
	inv_box.slot_id = SLOT_EARS_LEFT
	toggleable_inventory += inv_box
	...
	pains.icon = 'modular_skyrat/icons/mob/screen/screen_pain.dmi'
	pains.screen_loc = ui_pain
	pains.hud = src
	infodisplay += pains

	redpains = new /obj/screen/fullscreen/pain()
	redpains.icon = 'modular_skyrat/icons/mob/screen/screen_full.dmi'
	...
	for(var/obj/screen/inventory/inv in (static_inventory + toggleable_inventory + extra_inventory))
		if(inv.slot_id)
			inv.hud = src
