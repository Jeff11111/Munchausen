...
/datum/dynamic_ruleset/roundstart/overthrow
	name = "Overthrow"
 	...
 	protected_roles = list("Chaplain", "Security Officer", "Warden", "Detective", "Brig Physician", "Chief Enforcer", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster", "Prisoner", "Brig Physician", "Blueshield") 
