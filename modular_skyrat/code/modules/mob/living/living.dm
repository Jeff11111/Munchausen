...
/mob/living/proc/on_examine_atom(atom/examined)
	...
	if(!ismob(examined))
		visible_message("<span class='notice'>\The <b>[src]</b> looks at [examined].</span>", \
						"<span class='notice'>I look at [examined].</span>", vision_distance = 4)
	else
		visible_message("<span class='notice'>\The <b>[src]</b> looks at <b>[examined]</b>.</span>", \
						"<span class='notice'>I look at <b>[examined]</b>.</span>", vision_distance = 4)
