/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	songs = list("2610" = sound(file = 'modular_skyrat/sound/music/dummyremix.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX), "1680" = sound(file = 'modular_skyrat/sound/music/rollermobster.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX)) //Dummy originally made by Toby Fox, remix by Emsdache. Roller Mobster by Carpenter Brut.
