...
/mob/living/simple_animal/hostile/megafauna/bubblegum
	...
	songs = list("1860" = sound(file = 'modular_skyrat/sound/music/bfgdivision.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX), "2070" = sound(file = 'modular_skyrat/sound/music/theonlythingtheyfearisyou.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX)) //Thanks Mr. Infringio!
