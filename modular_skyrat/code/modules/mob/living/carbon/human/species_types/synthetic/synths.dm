/datum/species/synth
	...
	inherent_traits = list(TRAIT_NOBREATH,TRAIT_RADIMMUNE,TRAIT_TOXIMMUNE,TRAIT_CLONEIMMUNE)
	...
	initial_inherent_traits = list(TRAIT_NOBREATH,TRAIT_RADIMMUNE,TRAIT_TOXIMMUNE,TRAIT_CLONEIMMUNE,TRAIT_DNC) //blah blah i explained above
...
/datum/species/synth/proc/assume_disguise(datum/species/S, mob/living/carbon/human/H) //rework the proc for it to NOT fuck up with dunmer/other skyrat custom races
	if(S && !istype(S, type))
		...
		attack_verb_continuous = S.attack_verb_continuous
		attack_sound = S.attack_sound
		kick_verb = S.kick_verb
		kick_verb_continuous = S.kick_verb_continuous
		bite_verb = S.bite_verb
		bite_verb_continuous = S.bite_verb_continuous
		...
		kick_verb = initial(kick_verb)
		kick_verb_continuous = initial(kick_verb_continuous)
		bite_verb = initial(bite_verb)
		bite_verb_continuous = initial(bite_verb_continuous)
...
/datum/species/synth/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	RegisterSignal(C, COMSIG_MOB_SAY, .proc/handle_speech)
	assume_disguise(old_species, C)
