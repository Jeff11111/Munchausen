/mob/living/carbon/proc/rot()
	...
	if(reagents?.has_reagent(/datum/reagent/toxin/formaldehyde, 1) || reagents?.has_reagent(/datum/reagent/medicine/preservahyde, 1))
		return
...
/mob/living/carbon/proc/handle_sleeping()
	if(sleeping && AmountSleeping() < 8 SECONDS)
		SetSleeping(8 SECONDS)
