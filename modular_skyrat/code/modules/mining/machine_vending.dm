/obj/machinery/mineral/equipment_vendor
	prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		new /datum/data/mining_equipment("Box of 12ga Slugs",			/obj/item/storage/box/lethalslugs,									400),
		new /datum/data/mining_equipment("Box of 12ga Buckshot Shells",	/obj/item/storage/box/lethalshot,									400),
		new /datum/data/mining_equipment("7.62mm Stripper Clip",		/obj/item/ammo_box/a762,											700),
		new /datum/data/mining_equipment("5.56mm Magazine",				/obj/item/ammo_box/magazine/m556,									900),
		new /datum/data/mining_equipment("7.62mm Magazine",				/obj/item/ammo_box/magazine/m762,									1500),
		new /datum/data/mining_equipment("L6 Saw Ammo Box",				/obj/item/ammo_box/magazine/mm195x129,								2250),
		...
		new /datum/data/mining_equipment("Pump-Action Shotgun",			/obj/item/gun/ballistic/shotgun,									4000),
		new /datum/data/mining_equipment("Bolt Action Rifle",			/obj/item/gun/ballistic/shotgun/boltaction,							5000),
		new /datum/data/mining_equipment("Riot Shotgun",				/obj/item/gun/ballistic/shotgun/riot,								6000),
		new /datum/data/mining_equipment("ARG Assault Rifle",			/obj/item/gun/ballistic/automatic/ar,								10000),
		new /datum/data/mining_equipment("NCK Assault Rifle",			/obj/item/gun/ballistic/automatic/ak,								15000),
		new /datum/data/mining_equipment("L6 Saw Light Machine Gun",	/obj/item/gun/ballistic/automatic/l6_saw/unrestricted,				20000),
		)
