...
/mob/living/carbon/human/proc/give_genitals(clean = FALSE)//clean will remove all pre-existing genitals. proc will then give them any genitals that are enabled in their DNA
	...
	if (NOGENITALS in dna.species.species_traits)
		return
	if(dna.features["has_vag"] && dna.species.has_vegana)
		give_genital(/obj/item/organ/genital/vagina)
	if(dna.features["has_womb"] && dna.species.has_whopper)
		give_genital(/obj/item/organ/genital/womb)
	if(dna.features["has_balls"] && dna.species.has_balls)
		give_genital(/obj/item/organ/genital/testicles)
	if(dna.features["has_breasts"] && dna.species.has_bobs)
		give_genital(/obj/item/organ/genital/breasts)
	if(dna.features["has_cock"] && dna.species.has_weiner)
